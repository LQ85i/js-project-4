...
/* harmony export */   "updateSidebarTodocount": () => (/* binding */ updateSidebarTodocount)
/* harmony export */ });
...
const updateSidebarTodocount = (projects) => {
    ...
    const today = (0,_factories__WEBPACK_IMPORTED_MODULE_2__.getTodayTodos)(projects).length;
    const upcoming = (0,_factories__WEBPACK_IMPORTED_MODULE_2__.getUpcomingTodos)(projects).length;
    const highPriority = (0,_factories__WEBPACK_IMPORTED_MODULE_2__.getHighPriorityTodos)(projects).length;
...
const updatePage = (projects) => {
    ;(0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.updateSidebarTodocount)(projects);
    if((0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.getCurrentTab)().id == "sidebar-today"){
        buildTodoview(projects, "Today");
    }
    else if((0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.getCurrentTab)().id == "sidebar-upcoming"){
        buildTodoview(projects, "Upcoming");
    }
    else if((0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.getCurrentTab)().id == "sidebar-highpriority"){
        buildTodoview(projects, "HighPriority");
    }
    else if((0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.getCurrentTab)().id.includes("sidebar-project-")){
        for(let i = 0; i < projects.length; i++) {
            if(projects[i].name == (0,_sidebar__WEBPACK_IMPORTED_MODULE_1__.getCurrentTab)().querySelector(".sidebar-text").innerHTML){
...
/* harmony import */ var _formFunctions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./formFunctions */ "./src/formFunctions.js");
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./storage */ "./src/storage.js");
/* harmony import */ var _factories__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./factories */ "./src/factories.js");
...
function defaultSetup() {
    ...
    let projects = (0,_storage__WEBPACK_IMPORTED_MODULE_5__.loadProjects)();
    if (projects == -1 || projects == null) {
        let defaultProject = (0,_factories__WEBPACK_IMPORTED_MODULE_6__.projectFactory)("default project")
        let defaultTodo = (0,_factories__WEBPACK_IMPORTED_MODULE_6__.todoFactory)(
            "default todo",
            "default description",
            new Date(),
            "Low",
        ...
        (0,_storage__WEBPACK_IMPORTED_MODULE_5__.saveTodo)(defaultTodo);
        (0,_storage__WEBPACK_IMPORTED_MODULE_5__.saveProject)(defaultProject);
        projects = [defaultProject];
    }
    (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.buildSidebarProjects)(projects);
    (0,_formFunctions__WEBPACK_IMPORTED_MODULE_4__.updateTodoFormProjects)(projects);
    (0,_todoview__WEBPACK_IMPORTED_MODULE_1__.updatePage)(projects);
    (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.setCurrentTab)(document.getElementById("sidebar-today"));
    (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.getCurrentTab)().classList.add("selected");
...
function addEventListeners() {
    ...
    document.getElementById("form-add-todo").addEventListener("submit", (e) => {
        ...
        (0,_formFunctions__WEBPACK_IMPORTED_MODULE_4__.formReaderTodo)(formData, projects);
    })
    document.getElementById("form-add-project").addEventListener("submit", (e) => {
        ...
        if (nameIsUnique) {
            ...
            (0,_formFunctions__WEBPACK_IMPORTED_MODULE_4__.formReaderProject)(formData, projects);
        }
        else {
    ...
    sidebar_today.addEventListener("click", () => {
        if (!sidebar_today.classList.contains("selected")) {
            (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.getCurrentTab)().classList.remove("selected");
            (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.setCurrentTab)(sidebar_today);
    ...
    sidebar_upcoming.addEventListener("click", () => {
        if (!sidebar_upcoming.classList.contains("selected")) {
            (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.getCurrentTab)().classList.remove("selected");
            (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.setCurrentTab)(sidebar_upcoming);
    ...
    sidebar_highpriority.addEventListener("click", () => {
        if (!sidebar_highpriority.classList.contains("selected")) {
            (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.getCurrentTab)().classList.remove("selected");
            (0,_sidebar__WEBPACK_IMPORTED_MODULE_3__.setCurrentTab)(sidebar_highpriority);
