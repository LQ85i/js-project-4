...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/line_horizontal.svg */ "./src/icons/line_horizontal.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/arrow_right.svg */ "./src/icons/arrow_right.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/today.svg */ "./src/icons/today.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/upcoming.svg */ "./src/icons/upcoming.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/high_priority.svg */ "./src/icons/high_priority.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_5___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/icon.svg */ "./src/icons/icon.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_6___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/menu.svg */ "./src/icons/menu.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/settings.svg */ "./src/icons/settings.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_8___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/edit.svg */ "./src/icons/edit.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_9___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/checkbox_no.svg */ "./src/icons/checkbox_no.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_10___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/delete.svg */ "./src/icons/delete.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_11___ = new URL(/* asset import */ __webpack_require__(/*! ./icons/checkbox_yes.svg */ "./src/icons/checkbox_yes.svg"), __webpack_require__.b);
...
/* harmony export */   "getHighPriorityTodos": () => (/* binding */ getHighPriorityTodos),
/* harmony export */   "getTodayTodos": () => (/* binding */ getTodayTodos),
/* harmony export */   "getUpcomingTodos": () => (/* binding */ getUpcomingTodos),
/* harmony export */   "projectFactory": () => (/* binding */ projectFactory),
/* harmony export */   "projectRemover": () => (/* binding */ projectRemover),
/* harmony export */   "todoFactory": () => (/* binding */ todoFactory),
/* harmony export */   "todoRemover": () => (/* binding */ todoRemover)
/* harmony export */ });
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/startOfTomorrow/index.js");
...
const getTodayTodos = (projects) => {
    ...
    for(let i = 0; i < projects.length; i++) {
        ...
        for(let j = 0; j < todos.length; j++){
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todos[j].dueDate)){
...
const getUpcomingTodos = (projects) => {
    ...
    for(let i = 0; i < projects.length; i++) {
        const todos = projects[i].getTodos();
        for(let j = 0; j < todos.length; j++){
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(),todos[j].dueDate) <= 0){
...
const todoRemover = (todo, projects) => {
    for(let i = 0; i < projects.length; i++) {
        if(projects[i].name == todo.projectName){
            (0,_storage__WEBPACK_IMPORTED_MODULE_0__.removeLocalTodo)(todo);
...
const projectRemover = (project, projects) => {
    ...
    for(let i = 0; i < projects.length; i++) {
        if(projectName == projects[i].name){
            (0,_storage__WEBPACK_IMPORTED_MODULE_0__.removeLocalProject)(projects[i]);
            projects.splice(i,1);
        }
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "formReaderProject": () => (/* binding */ formReaderProject),
/* harmony export */   "formReaderTodo": () => (/* binding */ formReaderTodo),
/* harmony export */   "updateTodoFormProjects": () => (/* binding */ updateTodoFormProjects)
/* harmony export */ });
...
const formReaderTodo = (formData, projects) => {
    const todo = (0,_factories__WEBPACK_IMPORTED_MODULE_0__.todoFactory)(
        formData.get("name"),
        formData.get("desc"),
        (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_4__["default"])(formData.get("date")),
    ...
    for(let i = 0; i < projects.length; i++) {
        if(projects[i].name == formData.get("project")){
            ...
            (0,_storage__WEBPACK_IMPORTED_MODULE_3__.saveTodo)(todo);
            break;
        }
    }
    (0,_todoview__WEBPACK_IMPORTED_MODULE_1__.updatePage)(projects);
}

const formReaderProject = (formData, projects) => {
    const projectName = formData.get("name");
    const project = (0,_factories__WEBPACK_IMPORTED_MODULE_0__.projectFactory)(projectName);
    projects.push(project);
    (0,_storage__WEBPACK_IMPORTED_MODULE_3__.saveProject)(project);
    (0,_sidebar__WEBPACK_IMPORTED_MODULE_2__.updateSidebarProjects)(projects)
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "buildSidebarProjects": () => (/* binding */ buildSidebarProjects),
/* harmony export */   "currentTab": () => (/* binding */ currentTab),
/* harmony export */   "updateSidebarProjects": () => (/* binding */ updateSidebarProjects)
/* harmony export */ });
/* harmony import */ var _formFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formFunctions */ "./src/formFunctions.js");
/* harmony import */ var _todoview__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todoview */ "./src/todoview.js");
...
const buildSidebarProjects = (projects) => {
    ...
    for(let i = 0; i < projects.length; i++) {
        ...
        project.addEventListener("click",(e)=>{
            if(!e.target.classList.contains("sidebar-project-remove")) {
                if(!project.classList.contains("selected")){
                    ...
                    (0,_todoview__WEBPACK_IMPORTED_MODULE_1__.buildTodoview)([projectData], "Project");
                }
            }
        });
        ...
        removeButton.addEventListener("click",()=>{
            ...
            (0,_factories__WEBPACK_IMPORTED_MODULE_2__.projectRemover)(project, projects);
            (0,_todoview__WEBPACK_IMPORTED_MODULE_1__.buildTodoview)(projects, "Today");
...
const updateSidebarProjects = (projects) => {
    ...
    (0,_formFunctions__WEBPACK_IMPORTED_MODULE_0__.updateTodoFormProjects)(projects);
}
...
/* harmony export */   "removeLocalProject": () => (/* binding */ removeLocalProject),
...
const loadProjects = () => {
    ...
    for (let i = 0; i < projectIDs.length; i++) {
        ...
        let project = (0,_factories__WEBPACK_IMPORTED_MODULE_0__.projectFactory)(projectName);
        project.id = projectID;
        if(todoIDs != null){
            for (let j = 0; j < todoIDs.length; j++) {
                const todoID = todoIDs[j];
                const todo = localStorage.getObj("todo"+todoID);
                todo.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.dueDate);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "buildTodoview": () => (/* binding */ buildTodoview),
/* harmony export */   "updatePage": () => (/* binding */ updatePage)
/* harmony export */ });
/* harmony import */ var _toggles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toggles */ "./src/toggles.js");
...
const buildTodoview = (projects, filter) => {
    ...
    let todos = undefined;
    if(filter == "Today") {
        todos = (0,_factories__WEBPACK_IMPORTED_MODULE_2__.getTodayTodos)(projects);
        
    }
    else if(filter == "Upcoming") {
        todos = (0,_factories__WEBPACK_IMPORTED_MODULE_2__.getUpcomingTodos)(projects);
    }
    else if(filter == "HighPriority") {
        todos = (0,_factories__WEBPACK_IMPORTED_MODULE_2__.getHighPriorityTodos)(projects);
    }
    ...
    todos.forEach(todo => {
        ...
        todo_item.addEventListener("click",(e)=>{
            if(e.target == e.currentTarget) {
                (0,_toggles__WEBPACK_IMPORTED_MODULE_0__.toggleTodoDescription)(todo_item);
            }
        });
        ...
        tDueDate.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todo.dueDate, 'dd.MM.yyyy');
        ...
        tCheckbox.addEventListener("click",(e)=>{
            (0,_factories__WEBPACK_IMPORTED_MODULE_2__.completeTodo)(todo);
            updatePage(projects);
        });

        tDelete.addEventListener("click",(e)=>{
            
            (0,_factories__WEBPACK_IMPORTED_MODULE_2__.todoRemover)(todo,projects);
            updatePage(projects);
        });
...
const updatePage = (projects) => {
    if(_sidebar__WEBPACK_IMPORTED_MODULE_1__.currentTab.id == "sidebar-today"){
        buildTodoview(projects, "Today");
    }
    else if(_sidebar__WEBPACK_IMPORTED_MODULE_1__.currentTab.id == "sidebar-upcoming"){
        buildTodoview(projects, "Upcoming");
    }
    else if(_sidebar__WEBPACK_IMPORTED_MODULE_1__.currentTab.id == "sidebar-highpriority"){
        buildTodoview(projects, "HighPriority");
    }
    else if(_sidebar__WEBPACK_IMPORTED_MODULE_1__.currentTab.id.includes("sidebar-project-")){
        for(let i = 0; i < projects.length; i++) {
            if(projects[i].name == _sidebar__WEBPACK_IMPORTED_MODULE_1__.currentTab.querySelector(".sidebar-text").innerHTML){
...
/* harmony export */   "toggleSidebarCategory": () => (/* binding */ toggleSidebarCategory),
/* harmony export */   "toggleTodoDescription": () => (/* binding */ toggleTodoDescription)
/* harmony export */ });
const toggleSidebar = () => {
...
module.exports = __webpack_require__.p + "b27c783b409fb1613644.svg";

/***/ }),

/***/ "./src/icons/checkbox_no.svg":
/*!***********************************!*\
  !*** ./src/icons/checkbox_no.svg ***!
  \***********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "5601cf05d5c33e918e48.svg";

/***/ }),

/***/ "./src/icons/checkbox_yes.svg":
/*!************************************!*\
  !*** ./src/icons/checkbox_yes.svg ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "800ffe3eaefa86f67ae0.svg";
...
/***/ "./src/icons/high_priority.svg":
/*!*************************************!*\
  !*** ./src/icons/high_priority.svg ***!
  \*************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "2a1829847c7931411029.svg";
...
/***/ "./src/icons/line_horizontal.svg":
/*!***************************************!*\
  !*** ./src/icons/line_horizontal.svg ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "651922161c28a7debbee.svg";
...
module.exports = __webpack_require__.p + "113d59e2703636dfe157.svg";
...
module.exports = __webpack_require__.p + "b06737d8c8a93744b27e.svg";
...
module.exports = __webpack_require__.p + "f24e6657183c1ddb4442.svg";
...
module.exports = __webpack_require__.p + "327527f1c390104cf021.svg";
...
/* harmony import */ var _todoview__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todoview */ "./src/todoview.js");
/* harmony import */ var _toggles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./toggles */ "./src/toggles.js");
/* harmony import */ var _factories__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./factories */ "./src/factories.js");
...
/* harmony import */ var _formFunctions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./formFunctions */ "./src/formFunctions.js");
...
function defaultSetup() {
    ...
    addTodoDate.setAttribute("min",(0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(),'yyyy-MM-dd'));
    
    let projects = (0,_storage__WEBPACK_IMPORTED_MODULE_6__.loadProjects)();
    if(projects == -1 || projects == null){
        projects = [];
    }
    (0,_sidebar__WEBPACK_IMPORTED_MODULE_4__.buildSidebarProjects)(projects);
    (0,_formFunctions__WEBPACK_IMPORTED_MODULE_5__.updateTodoFormProjects)(projects);
    _sidebar__WEBPACK_IMPORTED_MODULE_4__.currentTab = document.getElementById("sidebar-today");
    _sidebar__WEBPACK_IMPORTED_MODULE_4__.currentTab.classList.add("selected");
    (0,_todoview__WEBPACK_IMPORTED_MODULE_1__.buildTodoview)(projects, "Today");
...
function addEventListeners() {    
    ...
    document.getElementById("form-add-todo").addEventListener("submit", (e) => {
        ...
        (0,_formFunctions__WEBPACK_IMPORTED_MODULE_5__.formReaderTodo)(formData, projects);
    })
    document.getElementById("form-add-project").addEventListener("submit", (e) => {
        ...
        if(nameIsUnique) {
            ...
            (0,_formFunctions__WEBPACK_IMPORTED_MODULE_5__.formReaderProject)(formData, projects);
        }
        else {
    ...
    sidebar_toggle.addEventListener("click",()=>{
        ;(0,_toggles__WEBPACK_IMPORTED_MODULE_2__.toggleSidebar)();
    });
    
    sidebar_today.addEventListener("click",()=>{
        if(!sidebar_today.classList.contains("selected")){
            _sidebar__WEBPACK_IMPORTED_MODULE_4__.currentTab.classList.remove("selected");
            _sidebar__WEBPACK_IMPORTED_MODULE_4__.currentTab = sidebar_today;
    ...
    sidebar_upcoming.addEventListener("click",()=>{
        if(!sidebar_upcoming.classList.contains("selected")){
            _sidebar__WEBPACK_IMPORTED_MODULE_4__.currentTab.classList.remove("selected");
            _sidebar__WEBPACK_IMPORTED_MODULE_4__.currentTab = sidebar_upcoming;
            sidebar_upcoming.classList.add("selected");
        }
        (0,_todoview__WEBPACK_IMPORTED_MODULE_1__.buildTodoview)(projects, "Upcoming");
    });
    sidebar_highpriority.addEventListener("click",()=>{
        if(!sidebar_highpriority.classList.contains("selected")){
            _sidebar__WEBPACK_IMPORTED_MODULE_4__.currentTab.classList.remove("selected");
            _sidebar__WEBPACK_IMPORTED_MODULE_4__.currentTab = sidebar_highpriority;
            sidebar_highpriority.classList.add("selected");
        }
        (0,_todoview__WEBPACK_IMPORTED_MODULE_1__.buildTodoview)(projects, "HighPriority");
    });
