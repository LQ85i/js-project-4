const createPageUpcoming = (todos) => {
    ...
    todo_name.innerHTML = "upcoming todo";
    todo_duedate.innerHTML = "Tomorrow 12:12";
    todo_priority.innerHTML = "Medium";
